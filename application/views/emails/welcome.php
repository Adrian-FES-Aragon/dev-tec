                      ...
                      <tr>
                        <th class="small-12 large-12 columns first last">
                          <table>
                            <tr>
                              <th>
                                <h1 class="text-center">¡Bienvenido(a) al sistema <?= $nombre_usuario ?>!</h1>
                                <center data-parsed="">
                                  <table align="center" class="menu text-center float-center">
                                    <tr>
                                      <td>
                                        <table>
                                          <tr>
                                            <th class="menu-item float-center"><a href="#">Acerca de</a></th>
                                            <th class="menu-item float-center"><a href="#">Lista de procesos</a></th>
                                            <th class="menu-item float-center"><a href="#">Nuestra empresa</a></th>
                                            <th class="menu-item float-center"><a href="#">Contacto</a></th>
                                          </tr>
                                        </table>
                                      </td>
                                    </tr>
                          ...
                          <table>
                            <tr>
                              <th>
                                ...
                                <center data-parsed=""> <img src=<?= base_url('assets/img/icon.png') ?> align="center" class="float-center"> </center>
                                <table class="spacer">
                                  <tbody>
                                    <tr>
                                      <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
                                    ...
                                    <tr>
                                      <td>
                                        <table>
                                          <tbody>
                                            <tr>
                                              <td><a href="<?= base_url('login') ?>">Iniciar Sesión</a></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
                                  ...
                                  <table align="center" class="menu float-center">
                                    <tr>
                                      <td>
                                        <table>
                                          <tr>
                                            <th class="menu-item float-center"><a href="#">tecdev.com</a></th>
